              ...
              {!user ? (
                ...
                >
                  ...
                  <button 
                    ...
                    className="mt-10 w-full py-4 px-6 rounded-lg bg-brand-50 text-brand-950 font-black text-[10px] uppercase tracking-[0.2em] hover:bg-brand-950 hover:text-white transition-all duration-300 border border-brand-100"
                  >
                    Cerrar Sesión
                  </button>
                </motion.div>
