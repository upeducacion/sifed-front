  ...
  return (
    <section className="w-full py-16 px-4 md:px-8 bg-background">
      <div className="max-w-7xl mx-auto">
        ...
        {error && (
          <div className="w-full py-20 flex flex-col items-center justify-center text-center bg-red-50 rounded-lg border border-red-200">
        ...
        {isLoading && docentes.length === 0 && !error ? (
          ...
          <div className="w-full py-20 flex flex-col items-center justify-center text-center bg-white rounded-lg border border-border">
